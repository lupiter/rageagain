...
describe("parseTrackString", () => {
  it("correctly parses track strings", () => {
    const tests: [string, any][] = [
      ...
      ["CRUMB Locket ()", { artist: "CRUMB", song: "Locket", label: "" }],

      [
        "RAE SREMMURD ft. TRAVIS SCOTT Close (Universal)",
        {
          artist: "RAE SREMMURD ft. TRAVIS SCOTT",
          song: "Close",
          label: "Universal",
        },
      ],
      ...
      [
        ...
        {
          artist: "DUKE DUMONT _and_ EBENEZER",
          song: "Inhale",
          label: "Etc Etc",
        },
      ],
      ...
      ["360 Drugs (EMI)", { artist: "360", song: "Drugs", label: "EMI" }],

      [
        "SNAKEHIPS ft. ST RULEZ Cruzin' (Stay Home Tapes - Act 1) (Universal)",
        {
          artist: "SNAKEHIPS ft. ST RULEZ",
          song: "Cruzin' (Stay Home Tapes - Act 1)",
          label: "Universal",
        },
      ],
